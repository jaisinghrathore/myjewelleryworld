    ...
    <Layout title="Search">
      <Grid className={classes.mt1} container spacing={1}>
            ...
            <ListItem>
              <Box className={classes.fullWidth}>
                ...
                <Select fullWidth value={category} onChange={categoryHandler}>
                  <MenuItem style={{width:"10px!important"}} value="all">All</MenuItem>
                  {categories &&
        ...
        <Grid item md={9}>
          ...
          <Grid className={classes.mt1} container spacing={3}  style={{display:"flex",justifyContent: "center",placeItems:"center"}}>
